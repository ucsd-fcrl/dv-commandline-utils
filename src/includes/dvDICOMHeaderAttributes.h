...
//using TInstanceCreatingTime = gdcm::Attribute<0x0008,0x0013>; // Time of RECONSTRUCTION
//using TAcquisitionTime      = gdcm::Attribute<0x0008,0x0032>; // Time of ACQUISITION
//using TAcquisitionNumber    = gdcm::Attribute<0x0020,0x0012>;
//using TImageIndex           = gdcm::Attribute<0x0054,0x1330>;
