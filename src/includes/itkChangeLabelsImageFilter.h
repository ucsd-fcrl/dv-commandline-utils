...
namespace itk
{
  ...
  Functor::ChangeLabelsFunctor< typename TInputImage::PixelType, typename TOutputImage::PixelType> >
  {
  public:
    ...
    void SetLabelMap( std::map<typename TInputImage::PixelType, typename TInputImage::PixelType> value )
    {
