  ...
  const unsigned int SliceIndex)
{
  ...
  typename TImage::RegionType region = reader->GetOutput()->GetLargestPossibleRegion();
  ...
  extract->SetDirectionCollapseToStrategy( TExtract::DIRECTIONCOLLAPSETOSUBMATRIX );
