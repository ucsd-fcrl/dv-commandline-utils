...
main( int argc, char** argv )
{
  ...
  switch (dv::ReadImageIOBase(IImage)->GetComponentType())
    ...
    case itk::ImageIOBase::FLOAT:
      dv::AnisotropicSmoothing<3, float>(IImage, OImage, Iterations, TimeStep, Conductance);
      break;
    case itk::ImageIOBase::DOUBLE:
      dv::AnisotropicSmoothing<3, double>(IImage, OImage, Iterations, TimeStep, Conductance);
      break;
    default:
      std::cerr << "WARNING: Pixel type is not floating point; casting to double." << std::endl;
      dv::AnisotropicSmoothing<3, double>(IImage, OImage, Iterations, TimeStep, Conductance);
      return EXIT_FAILURE;
      break;
    }
