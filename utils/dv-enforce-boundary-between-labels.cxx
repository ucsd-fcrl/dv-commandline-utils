...
main(int argc, char* argv[])
{
  ...
  description.add_options()("help", "Print usage information.")(
    ...
    "Filename of the segmentation image.")("output-image",
                                           po::value<std::string>()->required(),
    ...
    "labels-2",
    po::value<std::vector<short>>()->multitoken(),
    "Second label set to extract.")("radius-1",
                                    po::value<short>()->default_value(1),
                                    "Dilation radius for set 1.")(
    "radius-2",
    po::value<short>()->default_value(1),
    "Dilation radius for set 2.")("replacement",
                                  po::value<short>()->default_value(0),
                                  "Dilation radius for set 2.");
