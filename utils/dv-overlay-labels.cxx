...
main(int argc, char* argv[])
{
  ...
  description.add_options()("help", "Print usage information.")(
    ...
    "Filename of the input image.")("label-image",
                                    po::value<std::string>()->required(),
  ...
  switch (dv::ReadImageIOBase(IImage)->GetComponentType()) {
    case itk::ImageIOBase::UCHAR:
      dv::OverlayLabels<3, unsigned char>(IImage, LImage, OImage);
      break;
    case itk::ImageIOBase::CHAR:
      dv::OverlayLabels<3, char>(IImage, LImage, OImage);
      break;
    case itk::ImageIOBase::USHORT:
      dv::OverlayLabels<3, unsigned short>(IImage, LImage, OImage);
      break;
    case itk::ImageIOBase::SHORT:
      dv::OverlayLabels<3, short>(IImage, LImage, OImage);
      break;
    case itk::ImageIOBase::UINT:
      dv::OverlayLabels<3, unsigned int>(IImage, LImage, OImage);
      break;
    case itk::ImageIOBase::INT:
      dv::OverlayLabels<3, int>(IImage, LImage, OImage);
      break;
    case itk::ImageIOBase::ULONG:
      dv::OverlayLabels<3, unsigned long>(IImage, LImage, OImage);
      break;
    case itk::ImageIOBase::LONG:
      dv::OverlayLabels<3, long>(IImage, LImage, OImage);
      break;
