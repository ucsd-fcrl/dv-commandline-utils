...
main(int argc, char* argv[])
{
  ...
  switch (dv::ReadImageIOBase(IImage)->GetComponentType()) {
    case itk::ImageIOBase::UCHAR:
      dv::ExtractOrthogonalSlice<3, unsigned char>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::CHAR:
      dv::ExtractOrthogonalSlice<3, char>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::USHORT:
      dv::ExtractOrthogonalSlice<3, unsigned short>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::SHORT:
      dv::ExtractOrthogonalSlice<3, short>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::UINT:
      dv::ExtractOrthogonalSlice<3, unsigned int>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::INT:
      dv::ExtractOrthogonalSlice<3, int>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::ULONG:
      dv::ExtractOrthogonalSlice<3, unsigned long>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::LONG:
      dv::ExtractOrthogonalSlice<3, long>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::FLOAT:
      dv::ExtractOrthogonalSlice<3, float>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    case itk::ImageIOBase::DOUBLE:
      dv::ExtractOrthogonalSlice<3, double>(
        IImage, OImage, DimensionIndex, SliceIndex);
      break;
    default:
