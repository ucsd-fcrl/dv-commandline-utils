...
main(int argc, char** argv)
{
  ...
  quality_map[VTK_QUALITY_RELATIVE_SIZE_SQUARED] =
  ...
  description.add_options()("help", "Print usage information.")(
    ...
    "metric",
    po::value<int>()->default_value(VTK_QUALITY_RADIUS_RATIO),
    metric_description.c_str())("cellwise",
                                po::value<bool>()->default_value(false),
                                "Calculate cellwise quality.");
  ...
  if (cellwise) {
    ...
    std::cout << "# Number of cells: " << qualityArray->GetNumberOfTuples()
              << std::endl;
