...
main(int argc, char** argv)
{
  ...
  description.add_options()("help", "Print usage information.")(
    ...
    "Min and max values for window scaling.")(
    "output-range",
    po::value<std::vector<double>>()->multitoken(),
    "Min and max values for output image.");
    ...
    case 2: {
      ...
      switch (dv::ReadImageIOBase(IImage)->GetComponentType()) {
        case itk::ImageIOBase::UCHAR:
          dv::WindowImage<DIM, unsigned char>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::CHAR:
          dv::WindowImage<DIM, char>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::USHORT:
          dv::WindowImage<DIM, unsigned short>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::SHORT:
          dv::WindowImage<DIM, short>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::UINT:
          dv::WindowImage<DIM, unsigned int>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::INT:
          dv::WindowImage<DIM, int>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::ULONG:
          dv::WindowImage<DIM, unsigned long>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::LONG:
          dv::WindowImage<DIM, long>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::FLOAT:
          dv::WindowImage<DIM, float>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        case itk::ImageIOBase::DOUBLE:
          dv::WindowImage<DIM, double>(
            IImage, OImage, scale, o_range, o_range_exists);
          break;
        default:
