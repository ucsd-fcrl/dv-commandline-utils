...
main(int argc, char** argv)
{
  ...
  description.add_options()("help", "Print usage information.")(
    ...
    "Default value (for unused tiles).");
  ...
  itkAssertOrThrowMacro(InputImages.size() <= (NumRows * NumCols),
                        "Too many images have been supplied.");
  ...
  switch (dv::ReadImageIOBase(InputImages[0])->GetComponentType()) {
    case itk::ImageIOBase::UCHAR:
      switch (dv::ReadImageIOBase(InputImages[0])->GetPixelType()) {
        case itk::ImageIOBase::RGB: /* If RGB... */
        {
          ...
          dv::TileImages<2, PixelType>(InputImages,
                                       OutputImage,
                                       NumRows,
                                       NumCols,
    ...
    case itk::ImageIOBase::CHAR:
      dv::TileImages<2, char>(InputImages,
                              OutputImage,
                              NumRows,
                              NumCols,
    ...
    case itk::ImageIOBase::USHORT:
      switch (dv::ReadImageIOBase(InputImages[0])->GetPixelType()) {
        ...
        case itk::ImageIOBase::SCALAR: /* regular */
          dv::TileImages<2, unsigned short>(
            InputImages,
            OutputImage,
            NumRows,
            NumCols,
            static_cast<unsigned short>(Background));
          break;
        default:
          std::cerr << "ERROR: Unrecognized pixel type." << std::endl;
          return EXIT_FAILURE;
    ...
    case itk::ImageIOBase::SHORT:
      dv::TileImages<2, short>(InputImages,
                               OutputImage,
                               NumRows,
                               NumCols,
    ...
    case itk::ImageIOBase::UINT:
      dv::TileImages<2, unsigned int>(InputImages,
                                      OutputImage,
                                      NumRows,
                                      NumCols,
                                      static_cast<unsigned int>(Background));
      break;
    case itk::ImageIOBase::INT:
      dv::TileImages<2, int>(InputImages,
                             OutputImage,
                             NumRows,
                             NumCols,
    ...
    case itk::ImageIOBase::ULONG:
      dv::TileImages<2, unsigned long>(InputImages,
                                       OutputImage,
                                       NumRows,
                                       NumCols,
    ...
    case itk::ImageIOBase::LONG:
      dv::TileImages<2, long>(InputImages,
                              OutputImage,
                              NumRows,
                              NumCols,
                              static_cast<long>(Background));
      break;
    case itk::ImageIOBase::FLOAT:
      dv::TileImages<2, float>(InputImages,
                               OutputImage,
                               NumRows,
                               NumCols,
    ...
    case itk::ImageIOBase::DOUBLE:
      dv::TileImages<2, double>(InputImages,
                                OutputImage,
                                NumRows,
                                NumCols,
