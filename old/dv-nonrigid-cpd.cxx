...
void
callback(const cpd::NonrigidResult&)
{
...
main(int argc, char** argv)
{
  ...
  description.add_options()("help", "Print usage information.")
    ...
    ("fixed-mesh",
     ...
     "Filename of the fixed input mesh.")("moving-mesh",
                                          po::value<std::string>()->required(),
                                          "Filename of the moving input mesh.")(
      "output-mesh",
      po::value<std::string>()->required(),
    ...
    ("max-iterations",
     po::value<size_t>()->default_value(150),
     "The default number of iterations allowed.")(
      ...
      "The default outlier weight.")("tolerance",
                                     po::value<double>()->default_value(1e-5),
    ...
    ("beta",
     ...
     "Value of beta coefficient.")("lambda",
                                   po::value<double>()->default_value(3.0),
                                   "Value of lambda coefficient.");
  ...
  std::cout
    << "Runtime (seconds): "
    << std::chrono::duration_cast<std::chrono::seconds>(result.runtime).count()
    << std::endl;
